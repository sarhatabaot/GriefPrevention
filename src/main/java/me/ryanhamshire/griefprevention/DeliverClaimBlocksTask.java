...
class DeliverClaimBlocksTask implements Runnable
{
    ...
    public DeliverClaimBlocksTask(Player player, GriefPrevention instance)
    {
        ...
        this.idleThresholdSquared = Config.config_claims_accruedIdleThreshold * Config.config_claims_accruedIdleThreshold;
    }
    ...
    public void run()
    {
        ...
        try
        {
            ...
            int accrualRate = Config.config_claims_blocksAccruedPerHour_default;
            ...
            if (isIdle)
            {
                ...
                accrualRate = (int) (accrualRate * (Config.config_claims_accruedIdlePercent / 100.0D));
            }
